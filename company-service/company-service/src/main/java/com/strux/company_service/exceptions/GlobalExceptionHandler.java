...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCompanyAlreadyExistsException(
            CompanyAlreadyExistsException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleCompanyServiceException(
            CompanyServiceException ex, WebRequest request) {

        log.error("Company service error: {}", ex.getMessage(), ex);
